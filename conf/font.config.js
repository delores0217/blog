...
module.exports = {
  ...
  FONT_URL: process.env.NEXT_PUBLIC_FONT_URL || [
    ...
    'https://fonts.googleapis.com/css2?family=Noto+Serif+SC:wght@300;400;500;700;900&display=swap',
...
'https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/6.0.0/css/all.min.css' // font-awesome 字体图标地址; 默认使用 CDN；若要使用本地文件可改为 '/vendor/fontawesome/css/all.min.css'；可选 CDN: https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css
